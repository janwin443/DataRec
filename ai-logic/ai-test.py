...
class detector(nn.Module):
    def __init__(self):
        ...
        self.fc2 = nn.Linear(64, 2) # output: MFT eintrag, keine MFT!
...
class training(nn.Module):
    def training(model, data_source, runden):
...
loader = DataLoader(SektorDataset("../shared/extracted"), batch_size=32, shuffle=True)
